    ...
    function(err) {
      ...
      if (transporter) {
        const mailOptions = {
          from: `"${process.env.SENDER_NAME || 'Equipe Milhão Digital'}" <${process.env.EMAIL_USER}>`,
          to: email,
          subject: '🎉 Pedido Confirmado - Acesso Liberado!',
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
              <div style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                <h1 style="margin: 0; font-size: 28px;">🎉 Pedido Confirmado!</h1>
                <p style="margin: 10px 0 0 0; font-size: 18px;">Bem-vindo à família ${process.env.BUSINESS_NAME || 'Milhão Digital'}!</p>
              </div>
              ...
              <div style="background: white; padding: 30px; border: 1px solid #e1e5e9; border-radius: 0 0 10px 10px;">
                ...
                <p style="font-size: 16px; line-height: 1.6; color: #333;">
                  Seu pedido <strong>#${pedidoId}</strong> foi confirmado com sucesso! Agora você tem acesso completo aos materiais.
                </p>
                
                <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 25px 0;">
                  <h3 style="color: #2c5aa0; margin-top: 0;">📦 Produtos Adquiridos:</h3>
                ...
                <div style="text-align: center; margin: 30px 0;">
                  <a href="https://site-monetizacao.onrender.com/area-membros.html" 
                     style="background: linear-gradient(135deg, #ff6b35 0%, #f59e0b 100%); 
                            color: white; padding: 15px 30px; text-decoration: none; 
                            border-radius: 8px; font-weight: bold; display: inline-block;">
                ...
                <div style="background: #d4edda; padding: 15px; border-radius: 8px; margin: 20px 0;">
                  <p style="margin: 0; color: #155724;">
                    <strong>📧 Próximos passos:</strong> Você receberá mais emails com instruções detalhadas e materiais complementares.
                  </p>
                </div>
              </div>
            </div>
